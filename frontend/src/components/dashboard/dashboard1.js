...
//         registration system for the Education and Training Evaluation Authority
//         and its provisions, including the collection of information necessary to
//         perform the test remotely.
//       </h5>

//       <h5>1- The purpose of identity verification</h5>

//       <p>
//         The purpose of taking a recent photo of the applicant and uploading the
//         identity to the system is to verify the identity of the laboratory,
//         reduce fraud and manipulation, and achieve fairness and integrity of the
//         test. - The identity verification of the laboratory is done
//         automatically, and the identity verification will be confirmed by
//         employees (for applicants) and female employees (for applicants) who are
//         only authorized to access personally identifiable information. These
//         employees have pledged to secure the confidentiality of this information
//         in accordance with the regulations in force in the Kingdom of Saudi
//         Arabia.
...
//             person or manipulate it will expose you to legal accountability and
//             legal penalties, including denial of the test result.
//           </li>
//           <li>
//             {" "}
...
//         Dear tester, the data you have provided us with is safe and is used only
//         for the purposes of verifying the identity of the test taker, and we
//         pledge to you to maintain the privacy of your data. We are also
...
//         violating confidentiality or cybercrime laws regarding information that
//         it has transmitted, provided or tampered with.
//         <ul>
//           <li>
//             {" "}
...
//           <li>
//             {" "}
//             This system does not collect personal information about you when you
//             visit the site unless you specifically and knowingly choose to
...
//             institutions, unless this is in the context of collective data used
//             for statistical purposes and research, without including any data
//             that may be used to identify you.
//           </li>
...
//             or unlawful destruction, accidental loss, alteration, unauthorized
